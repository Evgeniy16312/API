...
- [ ] `https://myazapis.ru` открывается с телефона  
- [ ] Регистрация мастера работает  
- [ ] `/m/slug` + QR ведут на страницу  
- [ ] Клиент создал запись  
- [ ] Мастер в Настройках указал email для уведомлений и сохранил  
- [ ] Письмо о записи пришло на email мастера (после cron flush при необходимости)  
- [ ] `/admin` — видно мастера, «+30 дней» работает  
